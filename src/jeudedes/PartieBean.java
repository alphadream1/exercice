...
public class PartieBean {
	...
	public static void main(String[] args) {
		PartieBean partie1 = new PartieBean("Ezio", "Papa");
		partie1.ajouterUnTour();
		partie1.changerJC();
	...
	private JoueurBean joueur1;
	private JoueurBean joueur2;
	private int NbreTour;
	private JoueurBean jC;

	// on peux déclarer les meme attribut en les separant par une virgule donc
